    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        <div className="lg:col-span-3">
          <form className="bg-white px-6 mt-12 py-12">
            <div className="border-b border-gray-900/10 pb-12">
              ...
              <p className="mt-2 text-sm leading-6 text-gray-500">Use a permanent address where you can receive mail.</p>
            ...
            <div className="mt-8 flex items-center justify-end gap-x-6">
              <button type="button" className="rounded-md bg-gray-100 px-6 py-[0.4rem] text-sm font-semibold leading-6 text-gray-900">
                Reset
              </button>
              <button
                type="submit"
        ...
        <div className="lg:col-span-2">
          <div className="mx-auto max-w-6xl mt-12 px-0 sm:px-0 lg:px-0 bg-white">
